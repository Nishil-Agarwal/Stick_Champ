...
public class Stick{
    ...
    public void rotate(Player player,int mount_startcoord,int mount_width,double red_target_start){
        ...
        trans.setOnFinished(event->{
            player.move(this.height,mount_startcoord,mount_startcoord+mount_width,red_target_start);
        });
    }
