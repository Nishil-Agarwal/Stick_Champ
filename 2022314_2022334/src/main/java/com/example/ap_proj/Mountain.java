...
public class Mountain {
    ...
    public Mountain(int xcoord,int width) {
        if (xcoord!=-1){
            ...
            mountain = new Rectangle(xcoord, 465, width, height);
            ...
            mountain = new Rectangle(this.xcoord, 465, this.width, height);
            this.mountain.setFill(Color.BLACK);
        }
        createtarget();
    }
    ...
    public class Redtarget{
        ...
        public Redtarget(double xcoord){          //xcoord to be of center of mountain
            ...
            this.target = new Rectangle(xcoord-6,462.5,WIDTH,HEIGHT);     //2.5 may cause issue due to decimal
